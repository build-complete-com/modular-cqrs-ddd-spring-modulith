package com.buildcomplete.examples.modularcqrsddd.write.adapters.sns.configuration;
...
public class SnsConfiguration {
    @Bean
    public NotificationMessagingTemplate notificationMessagingTemplate(AmazonSNS amazonSNS, ObjectMapper objectMapper) {
