package com.buildcomplete.examples.modularcqrsddd.write.adapters.sqs.configuration;
...
class SqsConfiguration {
    ...
    public AmazonSQSAsync amazonSQSAsync(AWSCredentialsProvider awsCredentialsProvider, AwsClientBuilder.EndpointConfiguration sqsEndpointConfiguration) {
