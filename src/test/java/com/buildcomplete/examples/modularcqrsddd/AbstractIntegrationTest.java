...
public class AbstractIntegrationTest {
  ...
  static {
    Stream.of(MONGO_DB_CONTAINER, LOCAL_STACK_CONTAINER, MARIA_DB_CONTAINER).parallel().forEach(GenericContainer::start);
    Runtime.getRuntime().addShutdownHook(new Thread(() -> {
      Stream.of(MONGO_DB_CONTAINER, LOCAL_STACK_CONTAINER, MARIA_DB_CONTAINER).parallel().forEach(GenericContainer::stop);
    }));
  }
